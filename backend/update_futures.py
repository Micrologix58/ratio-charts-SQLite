...
WATCHLIST_FILE = os.getenv("FUTURES_WATCHLIST_FILE", "futures_watchlist.csv")
...
def main():
    ...
    print(f"Loaded {len(rows)} curated futures rows from {path}")
    ...
    try:
        ...
        conn.close()
    print(f"Upserted {count} futures records into Companies")
